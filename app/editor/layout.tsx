...
import { Menu, BookOpen, LogOut, Home } from "lucide-react";
      ...
      <div className="flex h-screen overflow-hidden">
        ...
        >
          ...
          <nav className="flex flex-col space-y-4">
            <Link
              href="/editor/"
              className="flex items-center gap-2 hover:bg-green-200 p-2 rounded"
            >
              <Home size={18} color="black" />
              <h2 className="text-lg font-medium text-black">Inicio</h2>
            </Link>
            <Link
              href="/editor/semestres"
              className="flex items-center gap-2 hover:bg-green-200 p-2 rounded"
            >
              <BookOpen size={18} color="black" />
              <h2 className="text-lg font-medium text-black">Semestres</h2>
            </Link>
            <button
              onClick={handleLogout}
              className="flex items-center gap-2 hover:bg-green-200 p-2 rounded text-left w-full"
            >
        ...
        <div className="flex-1 flex flex-col overflow-y-auto">
          <header className="md:hidden bg-green-400 text-white p-4 flex items-center justify-between">
            <h1 className="text-lg font-bold text-black">Panel Editor</h1>
            <button
